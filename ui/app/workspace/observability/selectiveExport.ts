...
// normalizeSelectiveExportForForm upgrades persisted configurations from earlier
// fork releases. Internal rule IDs/priorities are hidden by the current UI, so they
// must be repaired here instead of trapping users behind an invisible Zod error.

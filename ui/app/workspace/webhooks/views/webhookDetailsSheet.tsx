							...
							<TableRow>
									...
									<Tooltip>
										...
										<TooltipContent className="max-w-xs">
											<div className="space-y-1">
												<p>
													<span className="font-medium">{i18n.t("supplemental.delivered")}</span>: {i18n.t("supplemental.webhookDeliveredHelp")}
												</p>
												<p>
													<span className="font-medium">{i18n.t("supplemental.retrying")}</span>: {i18n.t("supplemental.webhookRetryingHelp")}
												</p>
												<p>
													<span className="font-medium">{i18n.t("supplemental.failed")}</span>: {i18n.t("supplemental.webhookFailedHelp")}
												</p>
												<p>
													<span className="font-medium">{i18n.t("supplemental.retriesExhausted")}</span>: {i18n.t("supplemental.webhookExhaustedHelp")}
												</p>
											</div>
										</TooltipContent>
									</Tooltip>
								...
								<TableHead>
									<Tooltip>
										...
										<TooltipContent className="max-w-xs">
										{i18n.t("supplemental.webhookResponseChipsHelp")}
										</TooltipContent>
									</Tooltip>
								</TableHead>
										...
										<Fragment key={webhookId}>
											<TableRow data-testid={`webhook-delivery-row-${webhookId}`}>
												<TableCell className="px-2">
													...
													aria-label={expanded ? i18n.t("supplemental.collapseRedeliveries") : i18n.t("supplemental.expandRedeliveries")}

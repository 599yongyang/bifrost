					...
					<section className="space-y-4">
						<div className="flex items-start justify-between gap-4">
							...
							>
								...
								<SelectContent>
									<SelectItem value="OR">OR · {i18n.t("workspace.circuitBreaker.operatorAny")}</SelectItem>
									<SelectItem value="AND">AND · {i18n.t("workspace.circuitBreaker.operatorAll")}</SelectItem>
								</SelectContent>
							</Select>
						</div>

		...
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 px-4 md:px-6">
				...
				<Alert>
					...
					<AlertDescription>{i18n.t("workspace.providers.proxyScopeDescription")}</AlertDescription>
				</Alert>
								...
								<FormItem>
									...
									>
										...
										<SelectContent>
											...
											<SelectItem value="environment">{i18n.t("workspace.providers.environment")}</SelectItem>
										</SelectContent>
									</Select>
									<FormMessage />
								</FormItem>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<SecretVarInput
													placeholder={i18n.t("workspace.providers.proxyUrlPlaceholder")}
													{...field}
													value={field.value}
													disabled={!hasUpdateProviderAccess}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormControl>
													<SecretVarInput
														placeholder={i18n.t("workspace.providers.proxyUsernamePlaceholder")}
														{...field}
														value={field.value}
														disabled={!hasUpdateProviderAccess}
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormControl>
													<SecretVarInput
														type="password"
														placeholder={i18n.t("workspace.providers.proxyPasswordPlaceholder")}
														hideValueWhenEnv
														redactNonEnvValue
														{...field}
														value={field.value}
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<SecretVarInput
													variant="textarea"
													placeholder={i18n.t("workspace.providers.proxyCaCertificatePlaceholder")}
											...
											<FormDescription>{i18n.t("workspace.providers.proxyCaCertificateDescription")}</FormDescription>
											<FormMessage />
										</FormItem>
									)}
								/>
				...
				<div className="mb-6 flex justify-end space-x-2">
					...
					>
						{i18n.t("workspace.providers.saveProxyConfiguration")}
					</Button>
				</div>
			</form>
		</Form>

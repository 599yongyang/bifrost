	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-1">
				...
				<div className="text-muted-foreground mx-auto mt-2 w-full max-w-[600px] text-sm font-normal">{copy.emptyDescription}</div>
				<div className="mx-auto mt-6 flex flex-row flex-wrap items-center justify-center gap-2">
					...
					<Button aria-label={copy.createFirstRule} data-testid="create-routing-rule-btn" onClick={onAddClick} disabled={!canCreate}>
						{copy.newRule}
					</Button>
				</div>
			</div>

...
export default function ClientSettingsView() {
	...
	return (
		<div className="mx-auto w-full max-w-4xl space-y-6">
			<PageTitle title={t("workspace.config.clientSettings.title")}>{t("workspace.config.clientSettings.description")}</PageTitle>
				...
				<div className="flex items-center justify-between space-x-2">
					<div className="space-y-0.5">
						<label htmlFor="dump-errors-in-console-logs" className="text-sm font-medium">
							{t("workspace.config.clientSettings.dumpErrors")}
						</label>
						<p className="text-muted-foreground text-sm">{t("workspace.config.clientSettings.dumpErrorsDescription")}</p>
					</div>
					<Switch

			...
			<div className="space-y-1 text-sm">
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{i18n.t("workspace.dashboard.input")}</span>
					</span>
				...
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
						...
						<span className="text-zinc-600 dark:text-zinc-400">{i18n.t("workspace.dashboard.output")}</span>
					</span>
				...
				{data.cached_read_tokens > 0 && (
					<div className="flex items-center justify-between gap-4">
						<span className="flex items-center gap-1.5">
							...
							<span className="text-zinc-600 dark:text-zinc-400">{i18n.t("workspace.dashboard.cached")}</span>
						</span>

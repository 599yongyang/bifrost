						...
						<div className="flex shrink-0 flex-wrap items-center justify-center gap-x-4 gap-y-1 pt-2 text-[11px] leading-none">
							<span className="flex items-center gap-1.5">
								...
								<span className="text-primary">
									{i18n.t("workspace.dashboard.cachedValue", { value: formatCompactNumber(totalCachedRead) })}
								</span>
							</span>
							<span className="flex items-center gap-1.5">
								<span className="h-2 w-2 rounded-full" style={{ backgroundColor: METER_COLORS.input }} />
								<span className="text-muted-foreground">
									{i18n.t("workspace.promptRepository.messages.input")} {formatCompactNumber(totalPromptTokens)}
								</span>
							</span>
						</div>
					</div>

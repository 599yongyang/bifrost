						...
						<Tooltip>
							...
							<TooltipContent side="bottom">
								<div className="flex flex-col gap-0.5 text-xs tabular-nums">
									<span>
										<span className="inline-block w-12">{i18n.t("workspace.promptRepository.messages.input")}</span> {usage.prompt_tokens}{" "}
										{i18n.t("workspace.governance.teams.tokensUnit")}
									</span>
									<span>
										<span className="inline-block w-12">{i18n.t("workspace.promptRepository.messages.output")}</span>{" "}
										{usage.completion_tokens} {i18n.t("workspace.governance.teams.tokensUnit")}
									</span>
									<span>
										<span className="inline-block w-12">{i18n.t("workspace.promptRepository.messages.total")}</span> {usage.total_tokens}{" "}
										{i18n.t("workspace.governance.teams.tokensUnit")}
									</span>
								</div>
							</TooltipContent>
			...
			<div>
				{isStreaming && isEmpty ? (
					...
					<div className="text-muted-foreground min-h-[20px] text-sm italic">
						{i18n.t("workspace.promptRepository.messages.enterAssistantMessage")}
					</div>
				) : contentIsJson ? (
					<CodeEditor
						wrap

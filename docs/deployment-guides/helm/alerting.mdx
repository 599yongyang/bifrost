---
title: "Alerting"
description: "Configure Bifrost alert channels, rules, history retention, and webhook network controls in Helm"
icon: "bell"
---
...
<Note>
Governance rules require the referenced virtual keys, teams, customers, budgets, and rate limits under [`bifrost.governance`](/deployment-guides/helm/governance). Provider reliability rules instead query the configured logs store.
</Note>

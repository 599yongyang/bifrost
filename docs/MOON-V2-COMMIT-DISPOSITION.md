...
| `380f5fce3` | Simplified selective-export policies | `adapt-to-v2` | `1bf1a3b3b`; `plugins/otel/selection_test.go` |
...
| `426016f4a` | Persist selective-export settings | `adapt-to-v2` | `1bf1a3b3b`, `9f5c0bd8a`; canonical v2 OTEL config tests |
| `c0e37222f` | Harden alert evaluation/history UX | `reimplement` | `1cbf68c83`, `e969cc2ef`, `6fad88946`; alerting tests |
...
| `5d1704e2d` | Error-aware fallback routing | `reimplement` | `96fcdce15`, `425ce08ef`, `f5b862d64`, `493672a89`, `28215607d` |
| `423b4b401` | Plugin panic containment | `adapt-to-v2` | `b288c55d6`, `19336a043`, `28af37074`, `294804389`; panic tests |
...
| `938bcf552` | Scheduled daily quality reports | `reimplement` | `ecf7c477d`, `d15cd64b9`, `ed17a9ae7`; report tests |
| `57cb95e1a` | Local governance module in dynamic image | `adapt-to-v2` | `600847b25`; Docker workspace module assertions |
| `db9885de4` | Daily reports as background jobs | `reimplement` | `ecf7c477d`, `d15cd64b9`, `ed17a9ae7`; job/idempotency tests |

...
// In-flight selections keep using their loaded snapshot; subsequent selections
// observe the new filter without racing plugin create/update/disable operations.
